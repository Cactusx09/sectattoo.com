    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in show active" id="Asset">
                @includeIf('admin.assetLocations.relationships.assets', ['assets' => $assetLocation->assets])
            </div>
            <div class="tab-pane fade in" id="AssetsHistory">
                @includeIf('admin.assetLocations.relationships.assetshistories', ['assetshistories' => $assetLocation->assetshistories])
            </div>
        </div>
    </div>
</div>
